<x-filament-panels::page>
    <div class="space-y-6">
        ...
        @if ($this->service)
            ...
            {{-- Servis Durum Kaydı Ekleme Formu --}}
            <form wire:submit="addLog">
                @php
                    $logSection = $this->form->getComponent('Servis Durum Kaydı Ekleme');
                @endphp
                @if ($logSection)
                    {{ $logSection }}
                @endif
        ...
        @else
            <div
                ...
                <div class="text-center py-12">
                    ...
                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Hizmet numarası ile arama yaparak servis
                        bilgilerini görüntüleyebilirsiniz.</p>
                </div>
            </div>
        @endif
    </div>
